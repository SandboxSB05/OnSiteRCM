        ...
        <div className="sticky top-0 z-40 border-b border-[rgba(0,0,0,0.08)] bg-white/80 px-4 py-3 backdrop-blur-md lg:hidden">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <div className="h-20 w-32 overflow-hidden rounded-xl bg-white flex items-center justify-center shadow-sm mx-auto">
                  <img src={logo} alt="Relay logo" className="h-48 object-contain -translate-x-1 translate-y-0" />
                </div>
                <div>
            ...
            <div className="sticky top-0 flex h-screen flex-col overflow-hidden">
              ...
              <div className="border-b border-[rgba(0,0,0,0.06)] bg-gradient-to-br from-emerald-500 to-teal-600 px-4 py-5 text-white">
                <div className="flex flex-col items-center gap-4">
                  <div className="h-24 w-40 overflow-hidden rounded-2xl bg-white flex items-center justify-center shadow-md mx-auto">
                    <img src={logo} alt="Relay logo" className="h-56 object-contain -translate-x-1 translate-y-1" />
                  </div>
